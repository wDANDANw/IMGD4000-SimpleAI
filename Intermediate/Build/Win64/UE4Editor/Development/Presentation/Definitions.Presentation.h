#undef PRESENTATION_API
#undef PRESENTATION_VTABLE
...
#define UE_PROJECT_NAME Presentation
...
#define PRESENTATION_VTABLE DLLEXPORT_VTABLE
#define PRESENTATION_API DLLEXPORT
